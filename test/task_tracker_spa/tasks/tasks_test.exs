defmodule TaskTrackerSpa.TasksTest do
  ...
  describe "tasks" do
    ...
    @valid_attrs %{desc: "some desc", name: "some name", timeSpent: 42}
    @update_attrs %{desc: "some updated desc", name: "some updated name", timeSpent: 43}
    @invalid_attrs %{desc: nil, name: nil, timeSpent: nil}
